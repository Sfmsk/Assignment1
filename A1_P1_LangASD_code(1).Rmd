...
dataa = merge(alldata1, alldata2, by = c("SUBJ", "VISIT"))
alldata = merge(dataa, alldata3, by = c("SUBJ", "VISIT"))
...
subset = subset(alldata, VISIT == "1", select = c(SUBJ, ADOS, nonVerbalIQ, verbalIQ))
subset = plyr::rename(subset, c("ADOS" = "ADOS1", "nonVerbalIQ" = "nonVerbalIQ1", "verbalIQ" = "verbalIQ1"))
mergedData = merge(alldata, subset, by = c("SUBJ"))
...
mergedData$SUBJ = as.factor(mergedData$SUBJ)
mergedData$SUBJ = as.numeric(mergedData$SUBJ, levels = 61)

mergedData$VISIT = as.numeric(mergedData$VISIT)

mergedData$Gender = as.factor(mergedData$Gender)
mergedData$Gender = revalue(mergedData$Gender, c("1" = "M", "2" = "F"))

mergedData$Diagnosis = revalue(mergedData$Diagnosis, c("A" = "ASD", "B" = "TD"))
...
write.csv(mergedData, file = "cleanData.csv")
